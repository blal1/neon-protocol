...
func _register_commands() -> void:
	var command_classes := [
		...
		preload("res://addons/godot_mcp/commands/advanced_3d_commands.gd"),
		...
		preload("res://addons/godot_mcp/commands/general_nodes_commands.gd"),
		preload("res://addons/godot_mcp/commands/ik_commands.gd"),
